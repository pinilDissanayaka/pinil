    ...
    <section className="about section" id="about">
      ...
      <div className="about_container container grid">
        ...
        <div className="about_data">
          ...
          <p className="about_description">I'm a dedicated machine learning engineer, data scientist and data engineer, on a perpetual quest to unearth the stories hidden in data.
